...
class _AppHomePageState extends State<AppHomePage> {
  ...
  _getStudents() async {
    var url = 'http://cs.sci.ubu.ac.th:7512/topic-1/Piyawat_59110440260/_search?from=${_page*10}&size=10';
    ...
    if (response.statusCode == 200) {
      ...
      result.forEach((item) {
        if (item.containsKey('_source')) {
          ...
          if (source.containsKey('name') && source.containsKey('age') && source.containsKey('address') && source.containsKey('img')) {
